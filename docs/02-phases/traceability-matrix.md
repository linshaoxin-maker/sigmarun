...
| FEAT-003（UC-002 · BDD-002-01/03/04 + 状态门 · D18） | packages/core/src/publish.ts；errors/exit/cli 扩展 | core/test/publish.test.ts（8 用例）—— 60/60 绿，RED 8 先行 | ✅ 交付（覆盖 93.5%/80.5%；BDD-002-02 claim 半场书面留待 FEAT-004；[FEAT-003/verification.md](../05-features/FEAT-003/verification.md)） |
